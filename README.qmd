...
What just happened?
We created an 'OD data frame' from geographic origins and destinations, and then estimated a simple gravity model based on the population in origin and destination zones and a custom distance decay function.
...
Note: this approach also allows you to use {si} functions in {dplyr} pipelines:
