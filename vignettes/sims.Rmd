...
The code presented below was written before the functions in the `si` package were developed, building on @dennett_estimating_2012. The aim is to demonstrate a common way of running SIMs, in a for loop, rather than using vectorised operations (used in the `si` package) which can be faster.
