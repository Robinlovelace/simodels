...
See the package's [README](https://robinlovelace.github.io/sim/) for instructions on installing the {sim} package.
...
```{r import}
u1 = "https://github.com/Robinlovelace/sim/releases/download/0.0.1/zones_aus.geojson"
...
Progress!
We have more than doubled the predictive ability of our model by using a 'production constrained' SIM, as defined mathematically in the [`sim-first-principles` vignette](https://robinlovelace.github.io/sim/articles/sims-first-principles.html).
