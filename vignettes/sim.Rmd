...
See the package's [README](https://robinlovelace.github.io/simm/) for instructions on installing the {sim} package.
...
This tutorial builds on a [reproducible](https://github.com/adamdennett/simModelling/blob/simModelling-Edits/simmAus2.Rmd) guide to SIMs in R [@dennett_modelling_2018].^[
...
```{r import}
u1 = "https://github.com/Robinlovelace/simm/releases/download/0.0.1/zones_aus.geojson"
...
The R package [{od}](https://itsleeds.github.io/od/), on which {sim} builds, assumes that inputs to its functions are in this form.
...
Key to the workings of the {sim} package is the conversion of geographic objects representing origins and destinations into an OD dataset.
...
Progress!
We have more than doubled the predictive ability of our model by using a 'production constrained' SIM, as defined mathematically in the [`sim-first-principles` vignette](https://robinlovelace.github.io/sim/articles/simms-first-principles.html).
